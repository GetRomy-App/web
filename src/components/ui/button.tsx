...
const variantClasses: Record<ButtonVariant, string> = {
  primary:
    "bg-neutral-900 text-white hover:bg-neutral-800 shadow-sm shadow-neutral-900/10 dark:bg-white dark:text-neutral-900 dark:hover:bg-neutral-200 dark:shadow-white/10",
  secondary:
