...
<!-- Title, description, canonical, OG & Twitter tags for this route are rendered once from the
     root layout, derived from the same `page` data this component receives as props — see
