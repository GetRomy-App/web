	...
	>
		<div class="gap-2 flex items-center">
			<svg
				...
				class="size-6 md:size-8 text-amber-500"
			>
				<path d="M17 17L21 21" />
				<path
			...
			<h2 class="text-foreground font-medium text-xl md:text-2xl tracking-tight leading-none">
				Donor Discovery
			</h2>
		</div>
	...
	>
		<div class="gap-2 flex items-center">
			<svg
				...
				stroke-linecap="round"
				stroke-linejoin="round"
				class="size-6 md:size-8 text-emerald-500"
			>
				<path
		...
		<p class="text-gray-alpha-600 leading-relaxed text-lg text-pretty">
			No enterprise contracts or per-seat licensing. Rōmy delivers the donor intelligence that used
			to cost tens of thousands — at a price built for small nonprofits.
		</p>
	</div>
	...
	>
		<div class="gap-2 flex items-center">
			<svg
				...
				stroke-width="1.5"
				stroke-linejoin="round"
				class="size-6 md:size-8 text-violet-500"
			>
				<path
