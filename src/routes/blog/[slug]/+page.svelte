...
<svelte:head>
	...
	<meta
		name="keywords"
		content="donor intelligence, nonprofit fundraising, major donor research, prospect research, AI donor research, wealth screening, Rōmy, {data.post.tag.toLowerCase()}"
	/>
