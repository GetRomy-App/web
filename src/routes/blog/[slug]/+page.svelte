...
<svelte:head>
	...
	<meta name="keywords" content="nonprofit fundraising, donor intelligence, prospect research, AI donor research, wealth screening, major gift fundraising, small nonprofit tools, {data.post.tag.toLowerCase()}, Rōmy" />
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		keywords: `nonprofit fundraising, donor intelligence, prospect research, AI donor research, wealth screening, ${data.post.tag}`
	})}</script>`}
	{@html `<script type="application/ld+json">${JSON.stringify({
		'@context': 'https://schema.org',
		'@type': 'BreadcrumbList',
