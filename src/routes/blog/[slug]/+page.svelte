...
<svelte:head>
	...
	<meta name="keywords" content="nonprofit fundraising, donor intelligence, prospect research, AI donor research, major gift fundraising, wealth screening, {data.post.tag.toLowerCase()}, small nonprofit tools" />
