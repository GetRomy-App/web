...
<svelte:head>
	...
	<meta name="keywords" content="{data.post.tag === 'Field Notes' ? 'nonprofit fundraising stories, major gift cultivation, donor relationship management, fundraising best practices, donor stewardship, development officer insights, small nonprofit fundraising, nonprofit field guide, major gift fundraising' : data.post.tag === 'Industry' ? 'nonprofit industry analysis, fundraising industry trends, donor intelligence industry, small nonprofit challenges, nonprofit sector insights, fundraising operations, major donor strategy' : data.post.tag === 'Engineering' ? 'donor intelligence engineering, AI prospect research technology, wealth screening technology, nonprofit software engineering, fundraising software architecture, AI fundraising tools' : data.post.tag === 'Data Science' ? 'donor capacity scoring, wealth screening data science, philanthropic data analysis, giving capacity prediction, RōmyScore methodology, prospect research scoring' : 'AI donor research benchmark, prospect research accuracy, AI wealth screening comparison, PIF-Bench benchmark, nonprofit AI research, donor intelligence comparison'}, donor intelligence, nonprofit fundraising, prospect research, AI donor research, wealth screening, major donor prospecting, nonprofit technology, Rōmy" />
