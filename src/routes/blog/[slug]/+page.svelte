...
<svelte:head>
	...
	<meta name="keywords" content="donor intelligence, nonprofit fundraising, prospect research, AI donor research, wealth screening, major donor prospecting, small nonprofit fundraising, giving history, donor capacity, philanthropy, {data.post.tag.toLowerCase()}, nonprofit development" />
	<meta name="author" content="Rōmy" />

	<meta property="og:title" content="{data.post.title} — Rōmy" />
	...
	<meta name="twitter:title" content="{data.post.title} — Rōmy" />
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		keywords: ['donor intelligence', 'nonprofit fundraising', 'prospect research', 'major donor', 'wealth screening', data.post.tag]
	})}</script>`}
