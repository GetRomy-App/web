...
<svelte:head>
	...
	<meta name="keywords" content="donor intelligence, nonprofit fundraising, major donor prospect research, AI donor research, wealth screening, {data.post.tag.toLowerCase()}" />
