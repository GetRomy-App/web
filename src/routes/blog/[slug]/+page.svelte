...
<svelte:head>
	...
	<meta
		name="keywords"
		content="donor intelligence, nonprofit fundraising, prospect research, AI donor research, wealth screening, major donor prospecting, {data.post.tag.toLowerCase()}"
	/>
	<meta
		name="robots"
