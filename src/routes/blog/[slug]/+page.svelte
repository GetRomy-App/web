...
<svelte:head>
	...
	<meta name="keywords" content="donor intelligence, nonprofit fundraising, prospect research, AI donor research, wealth screening, major gift fundraising, small nonprofit, {data.post.tag.toLowerCase()}" />
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		image: {
			'@type': 'ImageObject',
			url: 'https://getromy.app/og-image.png',
			width: 1200,
			height: 630
		},
		isPartOf: {
