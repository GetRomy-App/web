<script lang="ts">
	...
	const blogPostingSchema = $derived(JSON.stringify({
...
<svelte:head>
	...
	<meta name="keywords" content="nonprofit fundraising, donor intelligence, prospect research, major gift fundraising, AI donor research, wealth screening, nonprofit development, {data.post.tag.toLowerCase()}, small nonprofit fundraising, donor stewardship, charitable giving, nonprofit prospect research" />
