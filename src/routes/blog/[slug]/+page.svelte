...
<svelte:head>
	...
	<meta name="keywords" content="nonprofit fundraising, donor prospect research, major gift fundraising, AI donor intelligence, wealth screening, donor discovery, small nonprofit development, {data.post.tag.toLowerCase()}, nonprofit fundraising software, giving history analysis" />
	...
	<meta property="article:tag" content="prospect research" />
	...
	<meta name="twitter:image:alt" content="{data.post.title} — Rōmy" />
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		"keywords": ["nonprofit fundraising", "donor intelligence", "prospect research", "major gifts", "wealth screening", data.post.tag]
	})}</script>`}
