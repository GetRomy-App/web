...
<svelte:head>
	...
	<meta name="keywords" content="nonprofit fundraising, donor intelligence, prospect research, AI donor research, wealth screening, major gift fundraising, small nonprofit, {data.post.tag.toLowerCase()}" />
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		"keywords": `nonprofit fundraising, donor intelligence, prospect research, wealth screening, major gifts, small nonprofit, ${data.post.tag.toLowerCase()}`,
		"inLanguage": "en-US",
		"mainEntityOfPage": {
			"@type": "WebPage",
