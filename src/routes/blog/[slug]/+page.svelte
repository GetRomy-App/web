...
<svelte:head>
	...
	<meta name="keywords" content="nonprofit fundraising, donor intelligence, prospect research, AI donor research, wealth screening, major gift fundraising, {data.post.tag.toLowerCase()}, small nonprofit fundraising, donor cultivation, fundraising strategy" />
