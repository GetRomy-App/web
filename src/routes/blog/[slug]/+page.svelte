...
<svelte:head>
	...
	<meta name="keywords" content="donor intelligence, nonprofit fundraising, prospect research, AI donor research, wealth screening, major donor identification, {data.post.tag.toLowerCase()}" />
	...
	<!-- Structured data: lets search engines and AI answer engines cite this
	     post as a standalone, dated, authored article rather than an
	     undifferentiated page on the site. -->
