...
<svelte:head>
	...
	<meta name="keywords" content="nonprofit fundraising, donor intelligence, prospect research, major donor fundraising, AI donor research, wealth screening, nonprofit development, {data.post.tag.toLowerCase()}, small nonprofit fundraising, donor cultivation" />
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		"keywords": `nonprofit fundraising, donor intelligence, prospect research, ${data.post.tag.toLowerCase()}, major donor, wealth screening`
	})}</script>`}
	{@html `<script type="application/ld+json">${JSON.stringify({
		"@context": "https://schema.org",
		"@type": "BreadcrumbList",
