...
<svelte:head>
	...
	<meta name="keywords" content="{data.post.tag}, {data.post.title}, donor intelligence, nonprofit fundraising, prospect research, AI donor research, wealth screening" />
