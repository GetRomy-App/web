...
<svelte:head>
	...
	<meta
		name="keywords"
		content="donor intelligence, nonprofit fundraising, prospect research, AI donor research, wealth screening, {data.post.tag.toLowerCase()}, {data.post.title.toLowerCase()}"
	/>
