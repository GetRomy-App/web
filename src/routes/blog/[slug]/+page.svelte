...
<svelte:head>
	...
	<meta name="keywords" content="donor intelligence, nonprofit fundraising, prospect research, major gift fundraising, AI donor research, wealth screening, {data.post.tag.toLowerCase()}" />
