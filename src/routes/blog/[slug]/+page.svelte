<script lang="ts">
	...
	/** Meta descriptions render best under ~160 chars — post excerpts run much longer as on-page copy, so trim at a word boundary just for the tag. */
	...
	const metaDescription = $derived(truncateForMeta(data.post.excerpt));
...
<svelte:head>
	...
	<meta
		name="keywords"
		content="{data.post.tag.toLowerCase()}, donor intelligence, nonprofit fundraising, major donor prospecting, prospect research, AI donor research, wealth screening"
	/>
