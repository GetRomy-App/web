...
<svelte:head>
	...
	<meta
		name="description"
		content="Technical deep-dives, research findings, and perspectives on nonprofit fundraising, major donor prospect research, and purpose-built AI."
	/>
	<meta
		name="keywords"
		content="nonprofit fundraising blog, donor intelligence, major donor prospect research, AI for nonprofits, fundraising insights, wealth screening, donor discovery, small nonprofit fundraising, planned giving, major gifts"
	/>
	...
	<meta
		...
		content="Technical deep-dives, research findings, and perspectives on nonprofit fundraising and major donor prospect research."
	/>
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		description:
			'Technical deep-dives, research findings, and perspectives on nonprofit fundraising, major donor prospect research, and purpose-built AI.',
