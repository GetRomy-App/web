...
<svelte:head>
	...
	<meta
		name="keywords"
		content="nonprofit fundraising blog, donor intelligence, prospect research, major gift fundraising, wealth screening, AI for nonprofits, fundraising insights, development officer resources"
	/>
