...
<svelte:head>
	...
	<meta
		name="keywords"
		content="Rōmy blog, nonprofit fundraising blog, donor intelligence, prospect research, AI for nonprofits, major donor prospecting, fundraising insights, wealth screening"
	/>
