...
<svelte:head>
	...
	<meta
		name="description"
		content="Field notes and technical deep-dives on donor research, major gift fundraising, prospect research, and AI-powered donor intelligence for small nonprofit teams."
	/>
	<meta
		name="keywords"
		content="nonprofit fundraising blog, donor intelligence, prospect research, major donor fundraising, AI for nonprofits, wealth screening, donor discovery, planned giving, small nonprofit fundraising, Rōmy blog"
	/>
	<meta
		property="og:title"
	...
	<meta
		...
		content="Field notes and technical deep-dives on donor research, major gift fundraising, and AI-powered donor intelligence for small nonprofit teams."
	/>
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		description:
			'Field notes and technical deep-dives on donor research, major gift fundraising, prospect research, and AI-powered donor intelligence for small nonprofit teams.',
		publisher: {
			'@type': 'Organization',
			name: 'GetRomy LLC',
