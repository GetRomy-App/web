...
<svelte:head>
	...
	<meta
		name="keywords"
		content="nonprofit fundraising blog, donor intelligence, prospect research, AI for nonprofits, fundraising insights, donor stewardship, major donor prospecting, wealth screening"
	/>
	<meta
		property="og:title"
	...
	{@html `<script type="application/ld+json">${JSON.stringify(
		collectionPageSchema('Rōmy Blog', description, '/blog', data.posts, '/blog')
	)}</script>`}
</svelte:head>
