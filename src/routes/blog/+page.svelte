...
<svelte:head>
	...
	<meta
		name="description"
		content="Technical deep-dives, research findings, and perspectives on nonprofit fundraising, donor prospect research, and purpose-built AI from the Rōmy team."
	/>
	<meta
		name="keywords"
		content="nonprofit fundraising blog, donor intelligence, prospect research, AI for nonprofits, fundraising insights, major donor research, wealth screening, small nonprofit fundraising"
	/>
	<meta
		property="og:title"
