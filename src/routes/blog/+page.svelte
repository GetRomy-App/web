...
<svelte:head>
	...
	<meta
		name="description"
		content="Technical deep-dives, research findings, and perspectives on nonprofit fundraising, major donor prospecting, and purpose-built AI for small development shops."
	/>
	<meta
		name="keywords"
		content="nonprofit fundraising blog, donor intelligence, prospect research, AI for nonprofits, fundraising insights, major donor identification, donor stewardship, small nonprofit fundraising, wealth screening"
	/>
	...
	<meta name="twitter:description" content="Technical deep-dives, research findings, and perspectives on nonprofit fundraising, major donor prospecting, and purpose-built AI." />
