<script lang="ts">
	...
	const blogJsonLd = $derived({
		...
		'@type': 'CollectionPage',
		name: 'Rōmy Blog — Insights on AI Donor Research & Nonprofit Fundraising',
...
<Seo
	...
	description="Technical deep-dives, research findings, and perspectives on nonprofit fundraising, prospect research, and purpose-built AI."
	keywords="nonprofit fundraising blog, donor intelligence, prospect research, AI for nonprofits, fundraising insights, major donor prospecting, wealth screening, donor research"
	path="/blog"
	type="website"
	jsonLd={[blogJsonLd]}
/>
