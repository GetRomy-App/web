...
<svelte:head>
	...
	<meta
		name="keywords"
		content="nonprofit fundraising blog, donor intelligence, prospect research, AI for nonprofits, fundraising insights, major gift prospecting, wealth screening, donor discovery, nonprofit development"
	/>
	<meta
		name="robots"
