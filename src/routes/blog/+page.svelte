...
<svelte:head>
	...
	<meta
		name="keywords"
		content="nonprofit fundraising blog, donor intelligence, prospect research, AI for nonprofits, major gift fundraising, wealth screening, fundraising insights, nonprofit development"
	/>
