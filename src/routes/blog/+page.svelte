...
<svelte:head>
	...
	<meta
		name="description"
		content="Technical deep-dives, research findings, and field notes on nonprofit fundraising, major gift prospect research, donor wealth screening, and purpose-built AI from the Rōmy team."
	/>
	<meta
		name="keywords"
		content="nonprofit fundraising blog, donor intelligence, prospect research, wealth screening, major gifts, donor research, AI for nonprofits, fundraising insights, planned giving, donor stewardship"
	/>
	<meta
		name="robots"
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		description:
			'Technical deep-dives, research findings, and field notes on nonprofit fundraising, major gift prospect research, and purpose-built AI.',
		publisher: {
			'@type': 'Organization',
			name: 'GetRomy LLC',
