...
<svelte:head>
	...
	<meta
		name="description"
		content="Technical deep-dives, research findings, and field notes on nonprofit fundraising, major donor prospecting, and purpose-built AI donor intelligence — from the Rōmy team."
	/>
	<meta
		name="keywords"
		content="nonprofit fundraising blog, donor intelligence, prospect research, AI for nonprofits, major gifts, planned giving, fundraising insights, wealth screening"
	/>
	<meta
		name="robots"
	...
	<meta
		...
		content="Technical deep-dives, research findings, and field notes on nonprofit fundraising and AI donor intelligence."
	/>
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		description:
			'Technical deep-dives, research findings, and field notes on nonprofit fundraising and AI donor intelligence.',
		publisher: {
			'@type': 'Organization',
			name: 'GetRomy LLC',
			logo: {
