...
<svelte:head>
	<title>Rōmy Blog — Major Donor & Prospect Research Insights for Nonprofits</title>
	<meta
		name="description"
		content="Field notes, research findings, and perspectives on major-gift fundraising, prospect research, and purpose-built AI for small nonprofit teams."
	/>
	<meta
		name="keywords"
		content="nonprofit fundraising blog, major donor prospecting, donor intelligence, prospect research, AI for nonprofits, fundraising insights, development director resources"
	/>
	<meta name="robots" content="index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1" />
	<meta property="og:title" content="Rōmy Blog — Major Donor & Prospect Research Insights for Nonprofits" />
	<meta
		property="og:description"
		content="Field notes, research findings, and perspectives on major-gift fundraising and AI donor intelligence."
	/>
	...
	<meta name="twitter:title" content="Rōmy Blog — Major Donor & Prospect Research Insights for Nonprofits" />
	<meta
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		description:
			'Field notes, research findings, and perspectives on major-gift fundraising, prospect research, and AI donor intelligence.',
		publisher: {
			'@type': 'Organization',
			name: 'GetRomy LLC',
