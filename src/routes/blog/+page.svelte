...
<svelte:head>
	...
	<meta
		name="description"
		content="Technical deep-dives, research findings, and field notes on nonprofit fundraising, donor prospect research, and purpose-built AI."
	/>
	<meta
		name="keywords"
		content="nonprofit fundraising blog, donor intelligence, prospect research, wealth screening, AI for nonprofits, major donor fundraising, fundraising insights, donor stewardship"
	/>
	<meta
		property="og:title"
	...
	<meta
		...
		content="Technical deep-dives, research findings, and field notes on nonprofit fundraising and donor prospect research."
	/>
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		description:
			'Technical deep-dives, research findings, and field notes on nonprofit fundraising, donor prospect research, and purpose-built AI.',
