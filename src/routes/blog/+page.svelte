...
<svelte:head>
	...
	<meta
		name="description"
		content="Technical deep-dives, research findings, and perspectives on nonprofit fundraising, prospect research, donor intelligence, and purpose-built AI."
	/>
	<meta
		name="keywords"
		content="nonprofit fundraising blog, donor intelligence, prospect research, AI for nonprofits, fundraising insights, major gift officer resources, donor research best practices, wealth screening guide, nonprofit development blog, capacity rating, planned giving prospects"
	/>
	...
	<meta
		...
		content="Technical deep-dives, research findings, and perspectives on nonprofit fundraising, prospect research, and donor intelligence."
	/>
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		description:
			'Technical deep-dives, research findings, and perspectives on nonprofit fundraising, prospect research, and donor intelligence.',
		publisher: {
			'@type': 'Organization',
			name: 'GetRomy LLC',
