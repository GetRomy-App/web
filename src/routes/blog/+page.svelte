...
<svelte:head>
	<title>Rōmy Blog — AI Donor Research & Nonprofit Fundraising Insights</title>
	<meta
		name="description"
		content="Field notes, research findings, and perspectives on prospect research, major-gift fundraising, and purpose-built AI for small nonprofit development teams."
	/>
	<meta
		name="keywords"
		content="nonprofit fundraising blog, donor intelligence, prospect research, major gift fundraising, AI for nonprofits, wealth screening, fundraising insights, development office field notes"
	/>
	<meta
		property="og:title"
		content="Rōmy Blog — AI Donor Research & Nonprofit Fundraising Insights"
	/>
	<meta
	...
	<meta
		...
		content="Field notes, research findings, and perspectives on prospect research, major-gift fundraising, and purpose-built AI for small nonprofit development teams."
	/>
	<meta name="twitter:url" content="https://getromy.app/blog" />
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		description:
			'Field notes, research findings, and perspectives on prospect research, major-gift fundraising, and purpose-built AI for small nonprofit development teams.',
