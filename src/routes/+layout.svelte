<script lang="ts">
	...
	// Page- and post-specific title/description/canonical/OG/Twitter tags live in each
	// route's own <svelte:head> — SvelteKit only keeps one <title> across the whole tree,
	// so anything page-specific must NOT also be declared here or it silently loses.
</script>
...
<svelte:head>
	...
	<!-- Structured Data (JSON-LD) — sitewide brand entity, safe to repeat on every page -->
	{@html `<script type="application/ld+json">${JSON.stringify({
		'@context': 'https://schema.org',
		'@type': 'Organization',
		name: 'Rōmy',
		alternateName: 'GetRomy LLC',
