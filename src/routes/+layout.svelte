<script lang="ts">
	...
	// Every non-home route declares its own <title>/meta/OG/canonical tags. Svelte's SSR
	// head renderer keeps only one <title> (and search engines take the first of duplicate
	// meta tags), so this default block must stay scoped to "/" or it silently wins over
	// every page-specific override.
...
<svelte:head>
	...
	{#if isHome}
		...
		<meta
			name="keywords"
			content="nonprofit donor intelligence, fundraising software, prospect research tool, donor discovery platform, wealth screening, giving history, AI donor research, nonprofit fundraising, major donor prospecting, small nonprofit tools, donor management, philanthropy intelligence, fundraising CRM, nonprofit technology, donor wealth indicators, donor prospect research software, nonprofit CRM alternative, major gift officer software, capital campaign donor research, planned giving prospects, nonprofit development software, AI fundraising tools, donor capacity screening, best donor research tool for small nonprofits"
		/>
