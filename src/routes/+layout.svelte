...
<svelte:head>
	...
	<!--
		Page-specific tags (title, description, keywords, canonical, og:*, twitter:*) live in each
		+page.svelte, not here — a <svelte:head> in the layout and one in the page both rendering a
		<title> or <link rel="canonical"> produces two conflicting tags, and search engines only
		trust one of them. Only truly site-invariant tags belong at this level.
	-->
	...
	<!-- Open Graph / Twitter site identity (page-invariant) -->
