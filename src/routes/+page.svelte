...
<svelte:head>
	...
	<meta
		name="keywords"
		content="nonprofit donor intelligence, fundraising software, prospect research tool, donor discovery platform, wealth screening, wealth screening software, giving history, AI donor research, AI prospect research, nonprofit fundraising, major donor prospecting, major gift fundraising, small nonprofit tools, donor management, philanthropy intelligence, fundraising CRM, nonprofit technology, donor wealth indicators, donor prospect research software, find major donors, nonprofit donor discovery, affordable wealth screening"
	/>
	<meta
		name="robots"
