<script lang="ts">
	...
	const description =
		'Rōmy helps small nonprofits find new major donors at a fraction of the cost of existing solutions. AI-powered prospect research, wealth screening, and giving history — at a price built for small teams.';
