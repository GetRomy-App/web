...
<svelte:head>
	...
	<meta
		name="description"
		content="Rōmy scored 94.1 on PIF-Bench vs. Claude (92.3), Gemini (79.1), and ChatGPT (76.9). See how purpose-built AI donor intelligence compares on accuracy, cost, and speed."
	/>
	<meta
		name="keywords"
		content="donor research benchmark, AI prospect research comparison, nonprofit fundraising AI, wealth screening accuracy, PIF-Bench, donor intelligence cost comparison, ChatGPT vs Rōmy, Claude vs Rōmy, prospect research tool, AI donor research accuracy"
	/>
	<meta property="og:title" content="Rōmy Labs — AI Donor Research Benchmarks" />
	<meta
		property="og:description"
		content="PIF-Bench results: Rōmy 94.1, Claude 92.3, Gemini 79.1, ChatGPT 76.9. Open benchmarks for AI-powered prospect research."
	/>
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		description:
			'Open benchmark comparing Rōmy, Claude, Gemini, and ChatGPT on donor prospect research accuracy, factual precision, discovery recall, and hallucination rate.',
