...
<svelte:head>
	...
	<meta
		name="keywords"
		content="donor research benchmark, AI prospect research comparison, nonprofit fundraising AI, wealth screening accuracy, PIF-Bench, donor intelligence cost comparison, ChatGPT vs Rōmy, AI donor research accuracy, prospect research tool comparison"
	/>
	...
	<meta
		...
		content="PIF-Bench results: Rōmy 94.6, Claude 92.2, ChatGPT 79.9, Gemini 76.0. Open benchmarks for AI-powered prospect research."
	/>
	<meta name="twitter:url" content="https://getromy.app/labs" />
	<link rel="canonical" href="https://getromy.app/labs" />

	{@html `<script type="application/ld+json">${JSON.stringify({
		'@context': 'https://schema.org',
		'@type': 'Dataset',
		name: 'PIF-Bench: AI Donor Research Benchmark',
		description:
			'Ground-truth benchmark for AI donor prospect research fidelity, comparing Rōmy, Claude, ChatGPT, and Gemini on accuracy, cost, and speed.',
