<script lang="ts">
	...
	import { OG_IMAGE, buildBlogLd } from '$lib/seo';
...
<svelte:head>
	...
	<meta name="description" content={LABS_DESCRIPTION} />
	<meta
		name="keywords"
		content="donor research benchmark, AI prospect research comparison, nonprofit fundraising AI, wealth screening accuracy, PIF-Bench, donor intelligence cost comparison, ChatGPT vs Rōmy, prospect research tool, Rōmy Labs"
	/>
