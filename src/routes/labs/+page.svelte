<script lang="ts">
	...
	const pageTitle = 'Rōmy Labs — AI Donor Research Benchmarks, PIF-Bench Results & Blog';
...
<svelte:head>
	...
	<meta
		name="keywords"
		content="donor research benchmark, AI prospect research comparison, nonprofit fundraising AI, wealth screening accuracy, PIF-Bench, donor intelligence cost comparison, ChatGPT vs Rōmy, prospect research tool, AI benchmark nonprofit"
	/>
