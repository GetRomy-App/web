...
<svelte:head>
	...
	<meta
		name="description"
		content="Rōmy scored 94.1 on PIF-Bench vs. ChatGPT (76.9), Claude (92.3), and Gemini (79.1). See how purpose-built AI donor intelligence compares on accuracy, cost, and speed."
	/>
	<meta
		name="keywords"
	...
	<meta property="og:description" content="PIF-Bench results: Rōmy 94.1, Claude 92.3, Gemini 79.1, ChatGPT 76.9. Open benchmarks for AI-powered prospect research." />
	...
	<meta name="twitter:description" content="PIF-Bench results: Rōmy 94.1, Claude 92.3, Gemini 79.1, ChatGPT 76.9. Open benchmarks for AI-powered prospect research." />
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		description:
			'Open benchmark comparing Rōmy, Claude, ChatGPT, and Gemini on AI-powered donor prospect research across factual precision, discovery recall, hallucination rate, capacity estimation, source attribution, structural completeness, and actionability.',
