...
<svelte:head>
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		description:
			'Open benchmark comparing Rōmy, Claude, ChatGPT, and Gemini on AI-generated donor prospect research across factual precision, discovery recall, hallucination rate, capacity estimation, source attribution, structural completeness, and actionability.',
