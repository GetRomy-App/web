...
<svelte:head>
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		description:
			'Open benchmark comparing AI-powered donor prospect research systems (Rōmy, Claude, ChatGPT, Gemini) on factual precision, discovery recall, hallucination rate, capacity estimation, source attribution, structural completeness, and actionability.',
