<script lang="ts">
	...
	const labsJsonLd = $derived({
		'@context': 'https://schema.org',
		'@type': 'CollectionPage',
		name: 'Rōmy Labs — AI Donor Research Benchmarks, PIF-Bench Results & Blog',
...
<Seo
	...
	keywords="donor research benchmark, AI prospect research comparison, nonprofit fundraising AI, wealth screening accuracy, PIF-Bench, donor intelligence cost comparison, ChatGPT vs Rōmy, prospect research tool"
	path="/labs"
	type="website"
	jsonLd={[labsJsonLd]}
/>
