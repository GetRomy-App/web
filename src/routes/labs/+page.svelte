...
<svelte:head>
	...
	<meta
		name="keywords"
		content="donor research benchmark, AI prospect research comparison, nonprofit fundraising AI, wealth screening accuracy, PIF-Bench, donor intelligence cost comparison, ChatGPT vs Rōmy, prospect research tool, AI benchmark for nonprofits, LLM accuracy nonprofit research"
	/>
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		description:
			'Open benchmark comparing AI systems on donor prospect research accuracy, cost, and speed for nonprofit fundraising.',
