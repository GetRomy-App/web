<script lang="ts">
	...
	import { SITE, OG_IMAGE, breadcrumbJsonLd, blogJsonLd } from '$lib/seo';

	let { data } = $props();

	const jsonLdBreadcrumb = breadcrumbJsonLd([
		{ name: 'Home', url: SITE },
		{ name: 'Labs', url: `${SITE}/labs` }
	]);
	const jsonLdBlog = blogJsonLd({
		name: 'Rōmy Labs',
		description: 'Benchmarks and research on AI-powered donor prospect research.',
		url: `${SITE}/labs`,
		posts: data.posts,
		basePath: '/labs/blog'
	});
...
<svelte:head>
	...
	<meta
		name="keywords"
		content="donor research benchmark, AI prospect research comparison, nonprofit fundraising AI, wealth screening accuracy, PIF-Bench, donor intelligence cost comparison, ChatGPT vs Rōmy, prospect research tool, AI donor research benchmark, nonprofit AI accuracy comparison"
	/>
