...
<svelte:head>
	...
	<meta name="title" content="Rōmy Labs — AI Donor Research Benchmarks, PIF-Bench Results & Blog" />
	<meta
		name="description"
	...
	<meta
		name="keywords"
		content="Rōmy Labs, donor research benchmark, AI prospect research comparison, nonprofit fundraising AI, wealth screening accuracy, PIF-Bench, donor intelligence cost comparison, ChatGPT vs Rōmy, Claude vs Rōmy, prospect research tool"
	/>
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		description:
			'Composite accuracy benchmark comparing AI-powered donor prospect research systems (Rōmy, Claude, ChatGPT, Gemini) across factual precision, discovery recall, hallucination rate, capacity estimation, source attribution, structural completeness, and actionability.',
