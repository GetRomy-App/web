...
<svelte:head>
	<title>Rōmy Labs — AI Donor Research Benchmarks, PIF-Bench Results & Nonprofit AI Research</title>
	<meta
		name="description"
		content="Rōmy scored 94.6 on PIF-Bench vs. ChatGPT (79.9), Claude (92.2), and Gemini (76.0). Open benchmarks for AI-powered prospect research — accuracy, cost, speed, and depth compared."
	/>
	<meta
		name="keywords"
		content="donor research benchmark, AI prospect research comparison, nonprofit fundraising AI benchmark, wealth screening accuracy test, PIF-Bench prospect intelligence, donor intelligence cost comparison, ChatGPT vs Rōmy donor research, prospect research tool comparison, AI donor intelligence accuracy, nonprofit AI tools benchmark, iWave vs AI, DonorSearch alternative comparison, best prospect research tool, AI wealth screening, major donor research AI"
	/>
	<meta property="og:title" content="Rōmy Labs — AI Donor Research Benchmarks & PIF-Bench Results" />
	<meta property="og:description" content="PIF-Bench results: Rōmy 94.6, Claude 92.2, ChatGPT 79.9, Gemini 76.0. Open benchmarks for AI-powered nonprofit prospect research — accuracy, cost, and speed." />
	...
	<meta name="twitter:description" content="PIF-Bench results: Rōmy 94.6, Claude 92.2, ChatGPT 79.9, Gemini 76.0. Open benchmarks for AI-powered nonprofit prospect research." />
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		"description": "Open benchmarks comparing Rōmy against ChatGPT, Claude, and Gemini for AI-powered nonprofit prospect research. PIF-Bench framework results.",
		...
		"about": {
			"@type": "Thing",
			"name": "AI Donor Research Benchmarking",
			"description": "Comparative evaluation of AI systems for nonprofit prospect research using the PIF-Bench (Prospect Intelligence Fidelity) framework."
		}
	})}</script>`}
	{@html `<script type="application/ld+json">${JSON.stringify({
		"@context": "https://schema.org",
