...
<svelte:head>
	...
	<meta
		name="keywords"
		content="donor research benchmark, AI prospect research comparison, nonprofit fundraising AI, wealth screening accuracy, PIF-Bench, donor intelligence cost comparison, ChatGPT vs Rōmy, prospect research tool, AI donor intelligence benchmark"
	/>
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		description:
			'Benchmark comparing Rōmy, Claude, ChatGPT, and Gemini on AI-powered donor prospect research across factual precision, discovery recall, hallucination rate, capacity estimation, source attribution, structural completeness, and actionability.',
