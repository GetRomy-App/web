...
<svelte:head>
	...
	<meta
		name="keywords"
		content="donor research benchmark, AI prospect research comparison, nonprofit fundraising AI, wealth screening accuracy, PIF-Bench, donor intelligence cost comparison, ChatGPT vs Rōmy, prospect research tool, AI wealth screening benchmark"
	/>
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		'@type': 'Dataset',
		name: 'PIF-Bench — AI Donor Research Benchmark Results',
		description:
			'Benchmark comparing Rōmy, Claude, ChatGPT, and Gemini on donor prospect research accuracy, cost, and speed.',
