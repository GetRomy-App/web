...
<svelte:head>
	...
	<meta
		name="keywords"
		content="donor research benchmark, AI prospect research comparison, nonprofit fundraising AI, wealth screening accuracy, PIF-Bench, donor intelligence cost comparison, ChatGPT vs Rōmy, prospect research tool, AI donor research accuracy, nonprofit AI benchmark"
	/>
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		description:
			'Composite accuracy benchmark comparing Rōmy against ChatGPT, Claude, and Gemini on AI-powered donor prospect research.',
