...
<svelte:head>
	...
	<meta
		name="description"
		content="Rōmy scored 94.6 on PIF-Bench vs. ChatGPT (79.9), Claude (92.2), and Gemini (76.0). Open benchmarks comparing AI donor research tools on accuracy, hallucination rate, source attribution, and cost. Rōmy costs $0.50–$5 per report vs. $15K–$50K/yr for enterprise tools."
	/>
	<meta
		name="keywords"
		content="PIF-Bench donor research benchmark, AI prospect research comparison, best AI for nonprofit fundraising, Rōmy vs ChatGPT donor research, Rōmy vs DonorSearch, wealth screening accuracy benchmark, donor intelligence AI comparison, nonprofit AI tools comparison, prospect research tool benchmark, AI hallucination fundraising, donor research cost comparison, ChatGPT nonprofit research, Claude donor research, Gemini prospect research"
	/>
	...
	<meta name="twitter:description" content="PIF-Bench: Rōmy 94.6 > Claude 92.2 > ChatGPT 79.9 > Gemini 76.0. Open AI donor research benchmarks." />
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		"description": "Open benchmark measuring the accuracy of AI-generated donor prospect research. Evaluates factual precision, discovery recall, hallucination rate, capacity estimation accuracy, source attribution, structural completeness, and actionability. Rōmy scored 94.6 vs. Claude 92.2, ChatGPT 79.9, Gemini 76.0.",
