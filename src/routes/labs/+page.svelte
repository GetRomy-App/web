...
<svelte:head>
	<title>Rōmy Labs — AI Donor Research Benchmarks, PIF-Bench Results & Insights</title>
	<meta
		name="description"
		content="Rōmy scored 94.6 on PIF-Bench vs. ChatGPT (79.9), Claude (92.2), and Gemini (76.0). Open benchmarks comparing AI-powered donor prospect research on accuracy, cost, and speed."
	/>
	<meta
		name="keywords"
		content="donor research benchmark, AI prospect research comparison, PIF-Bench, nonprofit fundraising AI accuracy, wealth screening benchmark, donor intelligence cost comparison, best AI for nonprofit fundraising, prospect research tool comparison, Romy vs ChatGPT, Romy vs iWave, Romy vs DonorSearch"
	/>
	<meta property="og:title" content="Rōmy Labs — AI Donor Research Benchmarks & PIF-Bench Results" />
	<meta property="og:description" content="PIF-Bench results: Rōmy 94.6, Claude 92.2, ChatGPT 79.9, Gemini 76.0. Open benchmarks for AI-powered prospect research — accuracy, cost, and speed compared." />
	...
	<meta name="twitter:description" content="Rōmy 94.6 vs. ChatGPT 79.9, Claude 92.2, Gemini 76.0 on PIF-Bench. Open benchmarks for AI donor prospect research." />
