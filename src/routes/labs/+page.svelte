...
<svelte:head>
	...
	<meta name="twitter:title" content="Rōmy Labs — AI Donor Research Benchmarks, PIF-Bench Results & Blog" />
	<meta name="twitter:description" content="Rōmy scored 94.6 on PIF-Bench vs. ChatGPT (79.9), Claude (92.2), and Gemini (76.0)." />
