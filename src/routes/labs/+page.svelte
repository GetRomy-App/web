...
<svelte:head>
	<title>Rōmy Labs — AI Donor Research Benchmarks, PIF-Bench Scores & Prospect Research Research</title>
	<meta
		name="description"
		content="Rōmy scored 94.6 on PIF-Bench vs. ChatGPT (79.9), Claude (92.2), and Gemini (76.0). Open benchmarks comparing AI donor intelligence tools on accuracy, completeness, and actionability for nonprofit fundraising."
	/>
	<meta
		name="keywords"
		content="donor research AI benchmark, PIF-Bench prospect research, AI nonprofit fundraising comparison, wealth screening accuracy benchmark, donor intelligence tool comparison, ChatGPT vs Rōmy donor research, prospect research AI accuracy, nonprofit AI tools benchmark, fundraising software comparison, donor research accuracy study"
	/>
	<meta property="og:title" content="Rōmy Labs — AI Donor Research Benchmarks & PIF-Bench Results" />
	<meta property="og:description" content="PIF-Bench: Rōmy 94.6, Claude 92.2, ChatGPT 79.9, Gemini 76.0. Open benchmarks for AI-powered nonprofit prospect research." />
	...
	<meta name="twitter:description" content="PIF-Bench: Rōmy 94.6, Claude 92.2, ChatGPT 79.9, Gemini 76.0. Open benchmarks for AI nonprofit prospect research." />
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		description: 'An open evaluation framework for AI-powered donor research tools. PIF-Bench scores systems across five dimensions: Wealth Accuracy, Philanthropic History, Affinity Signal Detection, Profile Completeness, and Actionability.',
		...
		keywords: ['donor research', 'AI benchmark', 'prospect research', 'nonprofit fundraising', 'wealth screening', 'PIF-Bench']
	})}</script>`}
</svelte:head>
