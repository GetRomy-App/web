...
<svelte:head>
	...
	<meta
		name="keywords"
		content="donor research benchmark, AI prospect research comparison, nonprofit fundraising AI, wealth screening accuracy, PIF-Bench, donor intelligence cost comparison, ChatGPT vs Claude vs Gemini for fundraising, prospect research tool accuracy"
	/>
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		description:
			'A seven-dimension benchmark scoring AI systems (Rōmy, Claude, ChatGPT, Gemini) on donor prospect research fidelity — factual precision, hallucination rate, and actionability.',
