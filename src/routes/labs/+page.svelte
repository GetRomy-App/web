...
<svelte:head>
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		description:
			'Ground-truth benchmark comparing Rōmy, ChatGPT, Claude, and Gemini on donor prospect research accuracy.',
		url: 'https://getromy.app/labs',
		creator: { '@type': 'Organization', name: 'GetRomy LLC', url: 'https://getromy.app' },
		variableMeasured: [
			'Wealth indicator accuracy',
			'Giving history accuracy',
			'Ask amount recommendation quality',
			'Cost per report',
