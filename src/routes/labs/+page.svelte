<script lang="ts">
	...
	import { PIF_OVERALL, PIF_DIMENSIONS } from '$lib/benchmarks';
...
<svelte:head>
	...
	<meta
		name="keywords"
		content="donor research benchmark, AI prospect research comparison, nonprofit fundraising AI, wealth screening accuracy, PIF-Bench, donor intelligence cost comparison, ChatGPT vs Rōmy, prospect research tool, AI accuracy benchmark nonprofit"
	/>
	...
	<meta name="twitter:description" content="PIF-Bench results: Rōmy 94.6, Claude 92.2, ChatGPT 79.9, Gemini 76.0." />
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		description:
			'Open benchmark comparing AI-powered donor prospect research systems on factual precision, discovery recall, hallucination rate, capacity estimation, source attribution, structural completeness, and actionability.',
		...
		variableMeasured: PIF_DIMENSIONS.map((d) => d.label)
	})}</script>`}
