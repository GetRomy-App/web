...
<svelte:head>
	...
	<meta name="keywords" content="donor research benchmark, AI prospect research comparison, nonprofit fundraising AI, PIF-Bench, {data.post.tag.toLowerCase()}, {data.post.title.toLowerCase()}" />
