...
<svelte:head>
	...
	<meta
		name="keywords"
		content={data.post.keywords ||
			`AI donor research benchmark, donor intelligence, nonprofit fundraising, prospect research, wealth screening accuracy, ${data.post.tag.toLowerCase()}`}
	/>
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		keywords: data.post.keywords || undefined,
		author: {
			'@type': 'Organization',
			name: 'Rōmy',
