<script lang="ts">
	...
	const postUrl = $derived(`${SITE_URL}/labs/blog/${data.post.slug}`);
	const articleLd = $derived(blogPostingJsonLd(data.post, '/labs/blog'));
...
<svelte:head>
	...
	<meta name="keywords" content={postKeywords(data.post.tag)} />
	<meta
		name="robots"
