...
<svelte:head>
	...
	<meta name="keywords" content="PIF-Bench, AI donor research benchmark, prospect research accuracy, nonprofit fundraising AI, donor intelligence comparison, wealth screening benchmark, {data.post.tag.toLowerCase()}, Rōmy" />
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		"keywords": "PIF-Bench, AI donor research, prospect research benchmark, nonprofit fundraising AI, " + data.post.tag,
