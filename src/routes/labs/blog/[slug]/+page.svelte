...
<svelte:head>
	...
	<meta name="keywords" content="AI prospect research benchmark, PIF-Bench donor intelligence, nonprofit fundraising AI comparison, wealth screening accuracy, ChatGPT vs Romy, donor research benchmark, prospect research accuracy, nonprofit AI tools, donor intelligence platform, {data.post.tag.toLowerCase()}" />
