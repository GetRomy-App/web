...
<svelte:head>
	...
	<meta name="keywords" content="PIF-Bench, AI donor intelligence benchmark, nonprofit fundraising AI, prospect research accuracy, donor intelligence comparison, wealth screening, {data.post.tag.toLowerCase()}, Rōmy, nonprofit AI tools" />
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		keywords: ['PIF-Bench', 'AI donor intelligence', 'nonprofit fundraising', 'prospect research', 'wealth screening', data.post.tag],
		author: {
			'@type': 'Organization',
			name: 'GetRomy LLC',
