...
<svelte:head>
	...
	<meta name="keywords" content="AI donor research benchmark, nonprofit fundraising AI, prospect research accuracy, PIF-Bench, donor intelligence comparison, wealth screening accuracy, {data.post.tag.toLowerCase()}, nonprofit AI tools" />
