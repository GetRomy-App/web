...
<svelte:head>
	<title>{data.post.title} | Rōmy Labs — Nonprofit AI Research</title>
	<meta name="description" content={metaDescription} />
	<meta name="keywords" content="AI donor research, nonprofit fundraising benchmark, prospect research accuracy, donor intelligence AI, PIF-Bench, AI fundraising comparison, wealth screening AI, nonprofit technology research, {data.post.tag.toLowerCase()}" />
	...
	<meta property="article:tag" content="nonprofit AI research" />
	...
	<meta name="twitter:image:alt" content="{data.post.title} — Rōmy Labs" />
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		"about": [
			...
			{ "@type": "Thing", "name": "PIF-Bench benchmark" },
			{ "@type": "Thing", "name": data.post.tag }
		],
		"keywords": `AI donor research, nonprofit fundraising benchmark, prospect research, ${data.post.tag}, PIF-Bench, donor intelligence`
	})}</script>`}
