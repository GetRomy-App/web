...
<svelte:head>
	...
	<meta name="keywords" content="AI donor research, nonprofit fundraising research, prospect research benchmark, donor intelligence, wealth screening accuracy, nonprofit AI tools, PIF-Bench, {data.post.tag.toLowerCase()}, AI fundraising, nonprofit technology research" />
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		"keywords": `AI donor research, nonprofit fundraising, ${data.post.tag}, PIF-Bench`,
