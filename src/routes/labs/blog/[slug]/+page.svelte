<script lang="ts">
	...
	import { postKeywords, blogPostingSchema, breadcrumbSchema } from '$lib/seo';
...
<svelte:head>
	...
	<meta name="keywords" content={postKeywords(data.post)} />
	...
	{@html `<script type="application/ld+json">${JSON.stringify(
		blogPostingSchema(data.post, `/labs/blog/${data.post.slug}`)
	)}</script>`}
	{@html `<script type="application/ld+json">${JSON.stringify(
		breadcrumbSchema([
			{ name: 'Home', path: '/' },
