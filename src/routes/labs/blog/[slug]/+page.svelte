...
<svelte:head>
	...
	<meta
		name="keywords"
		content="donor intelligence, nonprofit fundraising, prospect research, AI donor research, wealth screening, AI benchmark, {data.post.tag.toLowerCase()}"
	/>
	...
	<meta name="twitter:url" content="https://getromy.app/labs/blog/{data.post.slug}" />
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		datePublished: data.post.date || undefined,
		dateModified: data.post.date || undefined,
