...
<svelte:head>
	...
	<meta name="keywords" content="AI donor research benchmark, nonprofit fundraising research, prospect research accuracy, PIF-Bench, wealth screening comparison, donor intelligence, {data.post.tag.toLowerCase()}" />
