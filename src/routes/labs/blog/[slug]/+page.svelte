...
<svelte:head>
	...
	<meta
		name="keywords"
		content="donor research benchmark, AI prospect research comparison, nonprofit fundraising AI, wealth screening accuracy, PIF-Bench, {data.post.tag.toLowerCase()}"
	/>
	<meta
		name="robots"
	...
	{@html `<script type="application/ld+json">${JSON.stringify({
		...
		keywords: `donor research benchmark, AI prospect research comparison, PIF-Bench, ${data.post.tag.toLowerCase()}`,
