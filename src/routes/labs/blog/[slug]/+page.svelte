...
<svelte:head>
	...
	<meta
		name="keywords"
		content="donor intelligence, nonprofit fundraising, prospect research, AI donor research, wealth screening, PIF-Bench, {data.post.tag.toLowerCase()}, {data.post.title.toLowerCase()}"
	/>
