<script lang="ts">
	...
	const pageUrl = $derived(`https://getromy.app/labs/blog/${data.post.slug}`);
</script>

<svelte:head>
	<title>{data.post.title} — Rōmy Labs</title>
	<meta name="description" content={data.post.excerpt} />
	<meta name="keywords" content="AI donor research benchmark, PIF-Bench, prospect research accuracy, donor intelligence, nonprofit fundraising AI, {data.post.tag.toLowerCase()}" />
