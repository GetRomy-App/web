<script lang="ts">
	...
	const title = `${data.post.title} — Rōmy Labs`;
	// svelte-ignore state_referenced_locally
	const keywords = `donor intelligence, nonprofit fundraising, prospect research, AI donor research, wealth screening, ${data.post.tag.toLowerCase()}`;
